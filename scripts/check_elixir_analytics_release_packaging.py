...
PACKAGE_RULES: list[PackageRule] = [
    ...
    },
    {
        ...
        "description": (
            "Core runtime changes that affect profile installation, plugin "
            "loading, toolset exposure, or trusted direct tool final responses."
        ),
    ...
    },
    {
        ...
        "description": (
            "Release packaging checker and Chandler-focused tests that verify "
            "the profile overlay against the Hermes interface."
        ),
        "matches": lambda path: path
        in {
